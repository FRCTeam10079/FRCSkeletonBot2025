...
public class RobotContainer {
    ...
    public final ShooterSubsystem dumpRoller = new ShooterSubsystem();
    public final ShooterSubsystem elevator = new ShooterSubsystem();
    public final ShooterSubsystem pivotSub = new ShooterSubsystem();
